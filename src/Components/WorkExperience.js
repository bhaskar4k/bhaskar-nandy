    ...
    for (let i = 0; i < work_experience.length; i++) {
      exp.push(
        <SingleWorkExperience
          ...
          starting_month={work_experience[i].starting_month}
          starting_year={work_experience[i].starting_year}
          ending_month={work_experience[i].ending_month}
          ending_year={work_experience[i].ending_year}
